...
?>
                                   <li><a href="home.php?project=<?php
        echo $project["projectID"];
?>"><?php
        echo "INF" . $project['projectYear'] . "" . $project['projectGroup'] . " " . $project['projectPeriode'] . " " . $project['projectName'] . "";
?></a></li>
                                    <?php
...
?></strong>
                                                ...
                                                <a class="waves-effect waves-light btn modal-trigger" href="#modal<?php
            echo $document['documentID'];
?>">Info</a>
                                            </div>
                                            <div class="col s4">
            ...
            echo $document['documentDeadline'];
?>>
                                            </div>
                                            <div class="col s3">
...
?>
                                               <h4><?php
                    echo $Advice['adviceType'];
?></h4>
                                                <p><?php
                    echo $Advice['adviceTekst'];
?></p>
                                                <?php
                }
                ;
...
?> 
                        <div class="col s12 m4 l4">
                            <ul id="projects-collection" class="collection z-depth-1">
                                ...
                                <li class="collection-item">
                                    <div class="row">
                                        <p class="collections-title"> Naam: <?php
echo $userName;
?></p>
                                    </div>
                                </li>
                                <li class="collection-item">
                                    <div class="row">
                                        <p class="collections-title"> Email: <?php
echo $userEmail;
?></p>
                                    </div>
                                </li>
